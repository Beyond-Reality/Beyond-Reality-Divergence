...
AssemblyTable.addRecipe(<beyondrealitycore:item4>, 60000, [<bigfactories:bigfactories_advgear>, <ore:ingotAlumite>, <ore:dustPyrotheum>, <ore:gearPlatinum>, <TConstruct:toolRod:11>, <beyondrealitycore:item3>]);
