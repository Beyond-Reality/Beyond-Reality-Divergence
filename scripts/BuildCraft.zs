...
AssemblyTable.addRecipe(<beyondrealitycore:item4>, 60000, [<bigfactories:bigfactories_advgear>, <ore:ingotAlumite>, <ore:dustPyrotheum>, <ThermalFoundation:material:135>, <TConstruct:toolRod:11>, <beyondrealitycore:item3>]);
