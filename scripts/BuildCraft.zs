...
AssemblyTable.addRecipe(<beyondrealitycore:item4>, 60000, [<ElectriCraft:electricraft_item_crystal>, <ore:ingotAlumite>, <ore:dustPyrotheum>, <ore:gearPlatinum>, <TConstruct:toughRod:11>, <beyondrealitycore:item3>]);
